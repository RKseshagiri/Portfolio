...
const Qualification = () => {
  ...
  return (
    <section id="qualification" className="qualification section">
      <h2 className="section__title">Qualification</h2>a
            ...
            <div className="qualification__data">
              <div>
                ...
                <span className="qualification__subtitle">
                  K.S.Rangasammy College of Arts & Science
                </span>
        ...
        >
          <div className="qualification__data">
            <div>
              ...
              <span className="qualification__subtitle">Rapiddata technologies</span>
              <div className="qualification__calender">
                <i className="uil uil-calendar-alt"></i> Aug 2022-Nov 2023
              </div>
            </div>
